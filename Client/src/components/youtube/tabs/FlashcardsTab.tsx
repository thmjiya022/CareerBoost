    ...
    return (
        <div className="bg-[#1A1B3A] border border-[#2A2B4A] rounded-lg">
            <div className="p-4 border-b border-[#2A2B4A]">
                <h2 className="text-white text-xl font-semibold">Flashcards for Review</h2>
            </div>
            ...
            <div className="p-6">
                {flashcards && flashcards.length > 0 ? (
                            ...
                            >
                                <div className="flex-1">
                                    {!flippedCards[idx] ? (
                                        ...
                                        <>
                                            <p className="text-green-400 font-semibold text-sm mb-2">Answer:</p>
                    ...
                    <p className="text-gray-500 text-center py-8">No flashcards available</p>
                )}
            </div>
        </div>
    );
