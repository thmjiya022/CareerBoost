				...
				<div className="container mx-auto px-4">
					<div className="max-w-4xl mx-auto text-center">
						...
						<p className="text-xl text-slate-300 mb-8">
							Empowering South African Youth Through AI-Powered Career
							Development
						</p>
					</div>
				</div>
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
							<div>
								...
								<div className="space-y-4 text-slate-300">
									<p>
										CareerBoost AI was born from a simple observation: millions
										of talented South African youth struggle to find meaningful
										employment despite their potential. We believe everyone
										deserves a fair shot at building a successful career.
									</p>
									<p>
										Our platform combines artificial intelligence with human
										expertise to provide personalized career guidance, skills
										development, and job matching specifically designed for the
										South African market.
									</p>
									<p>
										We're committed to breaking down barriers to employment and
										creating equal opportunities for all South Africans to
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
						<div className="text-center p-6">
							...
							<p className="text-slate-300">
								Making career development accessible to every South African,
						...
						<div className="text-center p-6">
							...
							<p className="text-slate-300">
								Leveraging cutting-edge AI technology to provide personalized
								career guidance at scale.
							</p>
						</div>
						...
						<div className="text-center p-6">
							...
							<p className="text-slate-300">
								Measuring our success by the real career outcomes and lives we
								transform.
							</p>
						</div>
					</div>
