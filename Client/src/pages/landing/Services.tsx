				...
				<div className="container mx-auto px-4">
					<div className="max-w-4xl mx-auto text-center">
						...
						<p className="text-xl text-slate-300 mb-8">
							Powerful AI tools built to help South African youth become
				...
				<div className="container mx-auto px-4">
					<div className="text-center mb-12">
						...
						<p className="text-slate-400 max-w-2xl mx-auto">
							CareerBoost combines advanced technology with real-world insights
							to help you grow.
						</p>
					</div>
				...
				<div className="container mx-auto px-4">
					<div className="text-center max-w-3xl mx-auto">
						...
						<p className="text-slate-300 mb-8">
							Whether you're looking for your first job or trying to level up
							your skills, CareerBoost gives you the tools to succeed.
						</p>
						<a
							href="/signup"
