	...
	const featuredServices: Service[] = [
		{
			...
			description:
				"Get instant AI-powered analysis of your CV. Identify gaps, get optimization tips, and stand out to employers.",
			price: "Free",
			duration: "Instant",
			features: [
				"ATS Optimization",
		...
		},
		{
			...
			description:
				"Turn YouTube into your classroom. Get curated content, notes, flashcards, and personalized learning plans.",
			price: "Free",
			duration: "Self-paced",
			features: [
				"Curated Content",
		...
		},
		{
			...
			description:
				"Discover South African job opportunities, salary insights, in-demand skills, and market trends tailored to you.",
			price: "Free",
			duration: "Real-time",
			features: [
				"Local Job Matches",
	...
	const benefits = [
		{
			...
			title: "30-Day Ready",
			description:
				"Become job-ready in just 30 days with our structured learning paths",
		},
		{
			icon: <Target className="w-12 h-12 text-pink-400" />,
			title: "AI-Powered",
			description:
				"Smart recommendations and personalized career guidance powered by AI",
		},
		{
			icon: <Flag className="w-12 h-12 text-red-400" />,
			title: "Local Focus",
			description:
				"Tailored specifically for South Africa's job market and opportunities",
		},
		{
			icon: <BarChart className="w-12 h-12 text-green-400" />,
			title: "Proven Success",
			description:
				"85% success rate with thousands of South African youth empowered",
		},
	];
			...
			<section className="pt-20 pb-20 px-6 text-center relative">
				<div className="max-w-5xl mx-auto">
					...
					<p className="text-xl md:text-2xl text-slate-400 mb-12 max-w-3xl mx-auto leading-relaxed">
						Your AI-powered career coach. Fix your CV, learn in-demand skills,
						and discover real job opportunities in South Africa.
					</p>
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					<div className="flex flex-wrap justify-center items-center gap-8 opacity-80">
						{technologies.map((tech, index) => (
							<div
								key={index}
								className="text-white font-medium text-lg hover:scale-110 transition-transform duration-300 bg-white/5 px-4 py-2 rounded-full border border-white/10"
							>
								{tech}
							</div>
						))}
				...
				<div className="max-w-7xl mx-auto px-6">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-slate-400 max-w-2xl mx-auto">
							We're transforming career development with AI-powered tools
							designed for South African youth
						</p>
					</div>
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
						{benefits.map((benefit, index) => (
							<div
								key={index}
								className="text-center group p-8 bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl hover:-translate-y-2 hover:bg-white/10 transition-all duration-300"
							>
			...
			<section className="py-20 px-6 relative">
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-slate-400 max-w-2xl mx-auto">
							Everything you need to launch your career in South Africa's
						...
						{[
							{
								num: "01",
								title: "Upload CV",
								desc: "Start with a quick CV analysis to identify your strengths and gaps",
								icon: <Upload className="w-8 h-8 mx-auto" />,
							},
							{
								num: "02",
								title: "Get Your Plan",
								desc: "Receive a personalized learning roadmap based on your career goals",
								icon: <Map className="w-8 h-8 mx-auto" />,
							},
							{
								num: "03",
								title: "Learn & Grow",
								desc: "Study with curated YouTube content and track your progress daily",
								icon: <Book className="w-8 h-8 mx-auto" />,
							},
							{
								num: "04",
								title: "Land Your Job",
								desc: "Apply to matched opportunities with confidence and preparation",
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
						<div>
							...
							<p className="text-xl text-slate-400 mb-8 leading-relaxed">
								In today's competitive job market, having the right skills and a
								standout CV is crucial for success. We combine AI technology
								with local market insights to help South African youth launch
								their careers.
							</p>
						...
						<div className="relative bg-linear-to-br from-blue-500/20 to-emerald-500/20 border-2 border-white/20 rounded-3xl p-8 text-center overflow-hidden">
							...
							<div className="relative z-10">
								...
								<p className="text-slate-300 mb-6">
									Join thousands of South African youth who are taking control
